...
export const labToolConfigs: Record<string, LabToolConfig> = {
  ...
  "monte-carlo": {
    ...
    assumptions: [
      ...
      "Probabilitas ruin = persentase simulasi yang berakhir dengan saldo â‰¤ 1% modal awal.",
  ...
  "trade-expectancy": {
    ...
    assumptions: [
      ...
      "Matriks: Expectancy (R) = (Win rate Ã- R:R) âˆ’ (1 âˆ’ Win rate). Nilai positif berarti strategi profitable secara matematis.",
  ...
  "pip-value": {
    ...
    assumptions: [
      "Nilai pip = pip size Ã- lot size Ã- contract size Ã· exchange rate.",
  ...
  "atr-trailing-stop": {
    ...
    assumptions: [
      "Stop level = Harga Â± (ATR Ã- Multiplier).",
