...
eyebrow: Legal
description: Terms that govern your use of Bursa. By accessing, registering, or using our services, you agree to these Terms, the Privacy Policy, and the Learner Guidelines.
sortOrder: 1
---
...
These Terms are governed by the laws of the Republic of Indonesia, including the PDP Law (Law No. 27/2022), the ITE Law, and the Consumer Protection Law.
...
Bursa provides education and technology infrastructure. Bursa is **not** a securities company, investment manager, licensed investment adviser, futures broker, bank, or OJK/Bappebti financial-services provider, and does not execute trades or give personalised investment recommendations.
...
Minimum age 18, or legal capacity in Indonesia. Below that age, use is only with a parent/guardian who is also bound by these Terms.

Registration data must be accurate. Accounts are **personal**. Sharing, renting, or reselling access is **forbidden**. Bursa may limit active devices. Account-sharing violations may lead to suspension without a refund.

You are responsible for keeping credentials confidential. Notify us promptly of unauthorised access. Optional Google login is subject to these Terms and the Privacy Policy.
...
You retain rights in User Content. By uploading, you grant Bursa a non-exclusive, royalty-free licence to operate the service. Private Notes are private by default.

Bursa may moderate or remove User Content that violates these Terms.
...
Copyright reports: legal@bursanalar.com.

## 7. Prohibited conduct

- Violating law, copyright, or privacy.
- Reverse-engineering, scraping, or extraction outside official interfaces.
- Guaranteed-profit claims, ponzi/MLM, spam, or specific buy/sell tips on instruments in community spaces (see the Learner Guidelines and POJK 6/2026).
- Payment abuse or unlawful chargebacks.
- Malware, unauthorised access, harassment, doxxing.
- Account sharing.
...
If community/signal features are active, they are educational tools. Mentor analysis is the mentor’s personal view, **not** Bursa investment advice. Learners must follow the [Learner Guidelines](/en/terms/learner-guidelines). Bursa may moderate, mute, or disable accounts (warning → mute → ban).
...
You indemnify Bursa against claims arising from your breach of these Terms.
...
Material changes are announced by email and/or notification, generally **not earlier than 14 days** before they take effect, except changes required by law or new features that do not materially reduce your rights. Continued use after the effective date is acceptance. The Privacy Policy and Learner Guidelines may be updated in the same way and are incorporated into these Terms.

## 20. Governing law & disputes

Laws of the Republic of Indonesia. Good-faith discussion for 30 days first, then the competent district court at the operator’s domicile, without prejudice to consumer dispute channels.

**No** mandatory arbitration clause or foreign-style class-action waiver.

## 21. General

These Terms + Privacy Policy + Learner Guidelines = the entire usage agreement.

- Severability: one invalid clause does not void the others.
- Language: **Indonesian governs**; translations are for convenience only.
- Assignment: you may not assign without permission; Bursa may assign in a business reorganisation.
