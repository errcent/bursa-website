      ...
      <section className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center px-6">
        ...
        <div className="relative z-10 mt-[30vh] max-w-2xl text-center">
          ...
          <div className="mt-8 flex justify-center gap-3">
            <button className="rounded-md bg-white px-5 py-2.5 text-sm font-medium text-black">
              Get Started
            </button>
            <button className="rounded-md border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-medium text-neutral-200">
              View Services
            </button>
          </div>
        </div>
