  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] w-full overflow-hidden rounded-xl bg-surface-2">
        ...
        {enrolled && (
          <span className="absolute right-2 top-2 rounded-full border border-accent/30 bg-accent/20 px-2 py-0.5 text-[10px] font-medium tracking-wide text-accent backdrop-blur-sm">
            Dimiliki
          </span>
        )}
