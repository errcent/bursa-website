      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          {granularityOptions.map((g) => (
            <button
              ...
              className={cn(
                ...
                value.granularity === g ? "bg-zinc-800 text-zinc-100" : "text-zinc-500 hover:text-zinc-300"
              )}
            >
              {granLabels[g][locale]}
            </button>
        ...
        <div ref={rootRef} className="relative flex items-center gap-0.5">
          ...
          <button
            ...
            className={cn(
              "inline-flex max-w-[10rem] items-center gap-1 rounded-md border px-2 py-1 text-[11px] font-medium sm:max-w-none",
              open
      ...
      {value.granularity !== "trade" ? (
        <label className="flex cursor-pointer items-center gap-2 text-[11px] text-zinc-500">
          <input
            ...
            className="size-3.5 rounded border-zinc-600 bg-zinc-900 accent-[var(--chart-up-strong)]"
          />
