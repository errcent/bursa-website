export const aboutHero = {
  ...
  description:
    "Bursa menempatkan mentor terverifikasi, materi berurutan, dan struktur belajar yang jelas sebagai tiga fokus setara. Tersedia kelas saham, crypto, dan forex dalam satu katalog.",
};
