...
const id: Messages = {
  ...
  settings: {
    ...
    account: {
      ...
      passwordMasked: "••••••••",
      passwordLastUpdated: "Terakhir diperbarui: belum tercatat (prototype).",
      ...
      passwordPrototypeNote:
        "Prototype UI — perubahan kata sandi akan diaktifkan setelah integrasi backend keamanan.",
      dangerZoneTitle: "Zona berbahaya",
      dangerZoneDescription:
        "Menonaktifkan atau menghapus akun akan menghapus akses ke progres belajar, chat, dan riwayat transaksi. Tindakan ini belum tersedia — hanya prototype antarmuka.",
    ...
    language: {
      ...
      enLabel: "English",
      enDescription: "Interface labels in English (prototype scope)",
...
const en: Messages = {
  ...
  settings: {
    ...
    account: {
      ...
      passwordMasked: "••••••••",
      passwordLastUpdated: "Last updated: not recorded yet (prototype).",
      ...
      cancel: "Cancel",
      passwordPrototypeNote:
        "Prototype UI — password changes will be enabled after security backend integration.",
      dangerZoneTitle: "Danger zone",
      dangerZoneDescription:
        "Deactivating or deleting your account removes access to learning progress, chat, and transaction history. This is not available yet — UI prototype only.",
